...
|---|---:|---:|---:|---|
| uniform_soft_voting | 0.8633 | 0.8635 | 0.4271 | M=4 균등 평균 |
| ts_uniform_soft_voting | 0.8667 | 0.8670 | 0.4372 | TS per-model → uniform avg |
| weight_opt_raw | 0.8750 | 0.8755 | 0.4168 | DE on raw probs, w=[0.207, 0.175, 0.517, 0.101] |
| weight_opt_ts | 0.8742 | 0.8745 | 0.4181 | DE on TS probs, w=[0.122, 0.194, 0.453, 0.231] |
| stacking_lr_oof | 0.8692 | 0.8694 | 0.3751 | 참고용; inference 배포시 predict.py 에 LR 통합 필요 — 최종 json 후보 제외 |
...
- val_macro_f1 = 0.8755
- val_nll = 0.4168
- weights = [0.2066, 0.1751, 0.5168, 0.1015]
